...
class _FakeQuery:
    ...
    def eq(self, col, val):
        ...
        # perché questi test verificano l'analytics, non lo scoping (che ha i
        # suoi test in tests/test_athlete_scoping.py). Filtrarlo davvero
        # svuoterebbe i dataset, che non portano quel campo.
        if col == "athlete_id":
            return self

...
- **Recupero lento post-sessioni hard (HRV delta -4.9%, TSB -33.88, readiness 27)** (n=1 sessione, confidence 0.5) → **IPOTESI Prescrizione**: Dopo TSB<-30 o HRV delta>-4%, inserire giorno di recupero attivo (30min Z1) o riposo completo prima carico successivo. **Expected outcome**: TSB ritorno a -15 entro 48h, readiness +10-15 punti.

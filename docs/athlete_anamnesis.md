...
- HR riposo: 50 bpm tipica (range 47-54)
- HRV rMSSD baseline: 80 ms (n=23)

## Pattern osservati (belief non flaggate, weak+)
- [validated_belief n=12 conf=0.95] Superamento zone in sessioni tecnica/recupero (HR media 151bpm in Z2 target, 80% Z3 in recovery)
- [validated_belief n=10 conf=0.95] Fatica muscolare braccia ricorrente + scarsa mobilità spalle (RPE 4, n=6 debrief, pace lenta)
- [validated_belief n=8 conf=0.95] Overpacing in test soglia (HR 194bpm, calo potenza finale, pacing irregolare)
- [weak_belief n=7 conf=0.91] RPE sottostimato Z3-Z4 (delta -1.5, RPE 2 con gambe pesanti, incoerenza HR 155bpm)
- [weak_belief n=5 conf=0.67] HRV più alto il martedì (media 86.0, z=+0.8)

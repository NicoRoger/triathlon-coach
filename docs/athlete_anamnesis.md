...
Carico al 2026-08-16: CTL 16.92 | ATL 0.47 | TSB 16.45 | readiness 57/100 (caution)

Prossime gare:
- 2026-08-29 (12gg): Lavarone Cross Sprint [A] — Lavarone

## Baseline fisiologiche (finestra 28gg)
- HR riposo: 52 bpm tipica (range 46-59)
- HRV rMSSD baseline: 77 ms (n=27)

## Pattern osservati (belief non flaggate, weak+)
- [validated_belief n=9 conf=0.95] RPE sottostimato in bici Z3-Z4 (delta -1.5, RPE 2 con gambe pesanti)
- [validated_belief n=14 conf=0.95] Difficoltà a mantenere il focus tecnico in sessioni lunghe di nuoto (durata > 3000s, distanza > 3km, RPE non allineato)
- [validated_belief n=9 conf=0.95] Tendenza a superare le zone di intensità previste nelle sessioni di tecnica/recupero (HR media 151bpm in Z2, picchi a 175bpm)
- [weak_belief n=9 conf=0.69] Tendenza a spingere oltre la Z2 target (HR media 147bpm, NP 243W in Z2)
